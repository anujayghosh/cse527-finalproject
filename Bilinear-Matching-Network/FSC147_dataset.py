...
class FSC147Dataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if file_name in self.images:
            ...
            print(f"Initial DM = {density_map.shape}")
            ...
            if points.shape[0] > 0:     
                ...
                for box in boxes:
                    ...
                    patch.save('C:\\Users\\anuja\\Desktop\\StonyBrookJan24\\CSE527_IntroToCV\\FinalProject\\Bilinear-Matching-Network-main\\data_list\\patch.png')
                    patches.append(self.query_transform(patch))
                    # img.save( 'C:\\Users\\anuja\\Desktop\\StonyBrookJan24\\CSE527_IntroToCV\\FinalProject\\Bilinear-Matching-Network-main\\data_list\\img.png')
                    # save_image(img, 'C:\\Users\\anuja\\Desktop\\StonyBrookJan24\\CSE527_IntroToCV\\FinalProject\\Bilinear-Matching-Network-main\\data_list\\img.png', normalize = True)
                    # calculate scale
...
class MainTransform(object):
    ...
    def __call__(self, img, target):
        ...
        print(f"pt map shpae = {pt_map.shape}")
